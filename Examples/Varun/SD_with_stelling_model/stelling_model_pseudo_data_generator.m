...
exps=load_step_input_experiment(number_of_replicates_per_input_class,model);             % 3 experiments implementing a ramp input
...
inputs.pathd.runident=strcat('Ramp_input_SData_',int2str(rand(1)));      % [] Identifier required in order not to overwrite previous results
