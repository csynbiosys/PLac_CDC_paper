...
% IPTGext max options
IPTGext_max_options=[10, 120, 200];

% randomly pick switching times to be either 60 or 120 or 180
switching_time_options=60.*[60 150 200]; %60.*[60, 75, 100, 120, 125, 150, 200, 250];%
...
for iexp=1:number_of_replicates_per_input_class
    ...
    % switching time
    switching_time= switching_time_options(iexp);                      % 250 minutes in seconds
