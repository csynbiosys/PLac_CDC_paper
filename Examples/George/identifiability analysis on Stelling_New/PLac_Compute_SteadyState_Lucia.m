function state = PLac_Compute_SteadyState_Lucia( theta, IPTG )
...
Cit_AU = Citrine_molec*sc_molec;

state = [L0 L1 L2 Lac12 Lac12m G20 G21 G22 IPTGi Citrine_molec Cit_AU];
end