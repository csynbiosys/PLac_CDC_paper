...
#define	k2         (*amigo_model).pars[1]
#define	kd         (*amigo_model).pars[2]
#define	k_2        (*amigo_model).pars[3]
#define	k1         (*amigo_model).pars[4]
#define	k_1        (*amigo_model).pars[5]
#define	kLac12     (*amigo_model).pars[6]
#define	kTP1       (*amigo_model).pars[7]
#define	kcat       (*amigo_model).pars[8]
#define	Km         (*amigo_model).pars[9]
#define	kout       (*amigo_model).pars[10]
#define	kC         (*amigo_model).pars[11]
#define	lk         (*amigo_model).pars[12]
